# Based on https://gitlab.mpcdf.mpg.de/struphy/struphy/-/blob/devel/src/struphy/dependencies.py
def get_dependencies(pymod_abs=None):
    '''Compute all dependencies that contain the string "kernels" of a Psydac module.
    ...
    if pymod_abs is None:
        ...
        assert 'psydac/' in pymod_abs and '.so' in pymod_abs
    ...
    booli = [i == 'psydac' for i in splits]
